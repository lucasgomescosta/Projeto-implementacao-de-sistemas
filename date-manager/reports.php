    ...
    <div class="row" align="center">
          <div class="col-sm-6 col-md-6 col-lg-6" align="center">
              ...
              <form id="filtroEmpresa" action="">
                ...
                <select style="font-color: white" name="filtrarEmpresas" class="form-control" align="center" style="background-color: transparent; background: transparent; color: #000; box-sizing: border-box; padding: 20px 30px; >
                   ...
                   <?php foreach($empresaFil as $empresa): ?> 
                      <option style="font-color: white" title="<?=$empresa->razao_social?>" style="color: write; background-color: rgba(0,0,0,0.80);" value="<?=$empresa->razao_social?>"><?=$empresa->razao_social?></option>
                   <?php endforeach;?> 
                </select>
          ...
          <div class="col-sm-6 col-md-6 col-lg-6" align="center" >
            <form  id="filtroDatas">    <p>Filtrar por Datas</p>
                <select style="font-color: white" name="filtrarDatas" class="form-control" align="center" style="background-color: transparent;  background: transparent;  color: #000; box-sizing: border-box; padding: 20px 30px; 
                color: #fff">
                  <option value="1"style="font-color: white">Todas as datas</option>
                  <option value="2"style="font-color: white">Datas vencidas</option>
                  <option value="3"style="font-color: white">Datas a vencer</option>
                </select>
